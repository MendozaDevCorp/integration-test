...
| `custom-landing-page.html` | Realistic landing page fixture. Same checks, plus campaign / landing-page ID wiring, and enough structure to exercise scroll-depth, click, download and form instrumentation |
